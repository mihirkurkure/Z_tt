...
void hist()
{
   ...
   TH1F *hpx1 = new TH1F("ete1","ztt",100,30,80);
   TH1F *hpx2 = new TH1F("ete1","gamma",100,30,80);
   TH1F *hpx3 = new TH1F("ete1","ww",100,30,80);
   TH1F *hpx4 = new TH1F("ete1","tt",100,30,80);
   ...
   Long64_t mentries = ztt->GetEntries();
   ...
   Long64_t oentries = ztt->GetEntries();
   ...
   Long64_t pentries = ztt->GetEntries();
